...
using Microsoft.ML;
    ...
    {
        public const string RetrainFilePath =  @"D:\Develop\ML.NET\ML.NET\myMLApp\yelp_labelled.txt";
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.Text.FeaturizeText(inputColumnName:@"col0",outputColumnName:@"col0")      
                                    ...
                                    .Append(mlContext.MulticlassClassification.Trainers.OneVersusAll(binaryEstimator:mlContext.BinaryClassification.Trainers.FastTree(new FastTreeBinaryTrainer.Options(){NumberOfLeaves=39,MinimumExampleCountPerLeaf=36,NumberOfTrees=23,MaximumBinCountPerFeature=302,FeatureFraction=0.858468462200342,LearningRate=0.893613386122843,LabelColumnName=@"col1",FeatureColumnName=@"Features"}),labelColumnName: @"col1"))      
